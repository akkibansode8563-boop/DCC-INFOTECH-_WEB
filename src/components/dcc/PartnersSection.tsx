...
const clientLogos = [
  ...
  { name: 'Institute', path: '/client_logos/client_212.png' },
  { name: 'Organization', path: '/client_logos/client_234.png' },
  { name: 'Autobahn', path: '/client_logos/client_236.png' },
  { name: 'Institution', path: '/client_logos/client_214.png' },
];
