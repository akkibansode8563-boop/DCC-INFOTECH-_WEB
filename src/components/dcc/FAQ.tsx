...
const faqs = [
  ...
  { question: 'What makes DCC Infotech different from other IT vendors?', answer: 'Four key factors set us apart: first, our 34 years of experience since 1992 means we have deep domain expertise and proven processes. Second, as an authorized distributor of 210+ brands, we offer genuine products at the best competitive pricing. Third, our "Where Service is a Way of Life" philosophy — we believe in building long-term relationships, not just completing transactions. Fourth, our ISO 9001, ISO 14001, ISO 27001, and ISO 20000-1 certifications ensure world-class quality and information security standards.' },
  { question: 'Can you help with IT infrastructure for a new office setup?', answer: 'Yes, new office IT setup is one of our core strengths through our "Office in the Box" unified communications solution. We provide end-to-end solutions including site assessment, network design and cabling, server room setup, workstation procurement and configuration, printer and peripheral setup, enterprise security (firewall, CCTV, endpoint security), and ongoing maintenance. We have successfully set up IT infrastructure for 3,150+ institutional clients across India.' },
];
...
export default function FAQ() {
  ...
  return (
    <section id="faq" ref={sectionRef} className="section bg-background overflow-hidden" aria-label="Frequently asked questions">
      {/* FAQPage structured data — improves rich-result eligibility in search */}
      ...
      <div className="mx-auto max-w-4xl">
        <motion.div initial="hidden" whileInView="show" viewport={viewportOnce} variants={fadeUp} className="mb-14 text-center">
          <div className="ledger-mark justify-center">
            <span className="ledger-index">11</span>
        ...
        <motion.div initial="hidden" whileInView="show" viewport={viewportOnce} variants={fadeUp}>
          <Accordion type="single" collapsible className="w-full">
            {faqs.map((faq, i) => (
              <AccordionItem key={i} value={`item-${i}`} className="border-b border-border/40 last:border-b-0">
        ...
        >
          <h3 className="mb-2 text-lg font-semibold text-foreground font-heading">Still have questions?</h3>
