...
const galleryImages = [
  { src: '/gallery/1.jpg', alt: 'Corporate Head Office' },
  { src: '/gallery/1 (1).jpg', alt: 'IT Infrastructure Project' },
  { src: '/gallery/1 (2).jpg', alt: 'Team Meeting' },
  { src: '/gallery/2.jpg', alt: 'Dell Authorised Store' },
  { src: '/gallery/2 (1).jpg', alt: 'Corporate Event' },
  { src: '/gallery/2 (2).jpg', alt: 'Technical Training Session' },
  { src: '/gallery/3.jpg', alt: 'Retail Peripherals Hub' },
  { src: '/gallery/3 (1).jpg', alt: 'Annual General Meet' },
  { src: '/gallery/3 (2).jpg', alt: 'Client Services Workshop' },
  { src: '/gallery/4.jpg', alt: 'DCC Logistics Warehouse' },
  { src: '/gallery/4 (1).jpg', alt: 'Partnership Summit' },
  { src: '/gallery/4 (2).jpg', alt: 'Engineering Repair Lab' },
  { src: '/gallery/5.jpg', alt: 'Customer Support Desk' },
  { src: '/gallery/5 (1).jpg', alt: 'Staff Outing Celebration' },
  { src: '/gallery/6.jpg', alt: 'Enterprise Security Solutions' },
  { src: '/gallery/6 (1).jpg', alt: 'NOC Operations' },
  { src: '/gallery/7.jpg', alt: 'Servers Deployment Project' },
  { src: '/gallery/7 (1).jpg', alt: 'Client Advisory Council' },
  { src: '/gallery/8.jpg', alt: 'Maintenance Desk' },
  { src: '/gallery/8 (1).jpg', alt: 'DCC Foundation Day' },
  { src: '/gallery/9.jpg', alt: 'Inventory Management System' },
  { src: '/gallery/9 (1).jpg', alt: 'Technical Leadership Meet' },
];
